      ...
      <View style={styles.container}>
        ...
        <View style={styles.headingContainer}>
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                        <Text style={styles.titleText1}>Look</Text><Text style={styles.titleText2}>APP</Text>
                    </View>
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                        <Text style={styles.subheading1}>Try Out Our</Text><Text style={styles.subheading2}> Amazing Filters</Text>
                    </View>
        </View>
        <View style={styles.middleContainer}>
          <Camera
            ...
            faceDetectorSettings={{
              mmode: FaceDetector.FaceDetectorMode.fast,
              ...
              {Object.keys(data).map(category => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    {
                      backgroundColor:
                        this.state.selected === category ? "#6278e4" : "#E7F2F8"
                    }
